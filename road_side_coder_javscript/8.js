...
setTimeout(() => {
  ...
  console.log(data.getStatus.call(this));
                                                                                                                                                    ...
                                                                                                                                                    // this refers to regular data object which is calling it, in first
                                                                                                                                                    //data.getStatus.call(this) calls getStatus with this is inside arrow function 
                                                                                                                                                    //so now getStatus is bound to the global object in second
...
array.push(elements); //array.push will push the array instead of elements rather we can do
                                                                                                                                                    ...
                                                                                                                                                    array.push.apply(array, elements); //[a,b,0,1,2] elements is an arrayList paased as an argument where it will push each element to the array.
...
function f() {
  ...
  user.g();
                                                                                                                                                      //it will return another function with context of null ,When user.g() is called, it executes boundFunction, which is essentially f with this bound to null
                                                                                                                                                      // window object
  ...
  f1().bind({name:"abc"}).bind({name:"cde"}) 
                                                                                                                                                        //print abc only as bind chaining not allowed
  //8)how to fix
  ...
  checkPassword(userObj.loginSuccess, userObj.loginfailed)
                                                                                                                                                    // sending reference of methods which are not bound to userObj and will look into checkpassword functions object which is window
...
//   purchaseCar.call(car1, "rupees", "41lacks")
  ...
  //context is an objec, this refers to the function on which myCall applies so that this starts pointing to context(object)
  Function.prototype.myCall = function (context = {}, ...args){
    if(typeof this !== "function") throw new Error(`${this} is not a function`)

        context.fn = this; // adding a fn in object and then assigning this function to it.
        context.fn(...args) // calling the assigned function with arguments
  }
